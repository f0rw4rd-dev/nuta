...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nuta.Backend.Products.Domain.Aggregates.Additive.Additive", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nuta.Backend.Products.Domain.Aggregates.Manufacturer.Manufacturer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nuta.Backend.Products.Domain.Aggregates.Product.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nuta.Backend.Products.Domain.Aggregates.ProductProposal.ProductProposal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nuta.Backend.Products.Domain.Aggregates.Product.Product", b =>
                {
                    b.HasOne("Nuta.Backend.Products.Domain.Aggregates.Manufacturer.Manufacturer", "Manufacturer")
                        .WithMany()
                    ...
                    b.OwnsMany("Nuta.Backend.Products.Domain.Aggregates.Product.ProductReview", "Reviews", b1 =>
                        {
                    ...
                    b.OwnsOne("Nuta.Backend.Products.Domain.Aggregates.Product.ValueObjects.ExternalScores", "ExternalScores", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Nuta.Backend.Products.Domain.Aggregates.Product.ValueObjects.Ingredients", "Ingredients", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Nuta.Backend.Products.Domain.Aggregates.Product.ValueObjects.Labels", "Labels", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Nuta.Backend.Products.Domain.Aggregates.Product.ValueObjects.NutaScore", "NutaScore", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Nuta.Backend.Products.Domain.Aggregates.Product.ValueObjects.NutritionFacts", "NutritionFacts", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uuid");
