...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nuta.Users.Domain.Aggregates.User.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nuta.Users.Domain.Aggregates.User.User", b =>
                {
                    b.OwnsMany("Nuta.Users.Domain.Aggregates.User.UserFavoriteProduct", "FavoriteProducts", b1 =>
                        {
                    ...
                    b.OwnsMany("Nuta.Users.Domain.Aggregates.User.UserProductView", "ViewedProducts", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid")
                                .HasColumnName("user_id");
                    ...
                    b.OwnsOne("Nuta.Users.Domain.Aggregates.User.ValueObjects.FoodPreferences", "FoodPreferences", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");
